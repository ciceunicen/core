...
public class loadDatabase {
    ...
    CommandLineRunner innitDatabaseProject(@Qualifier("projectServiceImp") ProjectServiceImp projectServiceImp){
        return args -> {
            ...
            Project p5= new Project("La Scaloneta","Se dedica a ganar campeonatos del mundo",new String[]{"foto9","foto10"},1l);
            ...
            log.info("Preloading " + projectServiceImp.addProject(p5,1L,new Long[]{1L},new Long[]{1L,3L},1L));
