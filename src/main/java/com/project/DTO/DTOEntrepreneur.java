...
public class DTOEntrepreneur {
    ...
    private boolean is_aceptada=false;
    ...
    public DTOEntrepreneur(Long id, Long dni, String name, String surname, String email, Long id_user, Boolean is_active, Long cuil_cuit, Long phone, String location, String howimetcice, boolean ispf, boolean is_deleted,boolean is_aceptada) {
        this.id = id;
        this.dni = dni;
        this.name = name;
        this.surname = surname;
